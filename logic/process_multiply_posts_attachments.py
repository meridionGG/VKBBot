...
async def process_multiply_posts_attachments(self, user_id: int, message: str, post: str, attachments, state_data: dict,):
    ...
    if message == "Да":
        ...
        await self.multiply_loader(self, attachments_list, user_id, session_id, post, link)
